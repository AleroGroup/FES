<template>
  ...
  <v-img :src="head__title" class="screen">
   <v-layout id="team-into" style="margin-left:12%;margin-top:4%">
      <h2 class="main__title font-weight-regular pa-3 ma-6 text-capitalize font-weight-medium"> To School Administrators and Staff </h2>
    </v-layout>
      ...
      <v-layout row wrap>
            ...
            <v-layout column mt-10 style="margin-left:18%;">
                ...
                <div> 
                     <p class="services_list"> 
                        <v-icon :color="icon_color">mdi-check</v-icon> 
                          Book-keeping, Accounting and Finance
                     </p>
                </div> 
                 <div> 
                     <p class="services_list">
...
export default {
data: () => ({
     title:"Services | To School Administrators and Staff",
